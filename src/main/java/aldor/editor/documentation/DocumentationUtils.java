...
public class DocumentationUtils {
    ...
    public String aldorDocString(Syme syme, PsiElement element, PsiElement originalElement) {
        ...
        AnnotatedOptional<AnnotationFileNavigator, String> annotationManager = moduleManager.annotationFileManagerForFile(element.getProject(), element.getContainingFile().getVirtualFile());
    ...
    public AnnotatedOptional<Syme, String> symeForElement(PsiElement element) {
        ...
        AnnotatedOptional<AnnotationFileNavigator, String> annotationManager = moduleManager.annotationFileManagerForFile(element.getProject(), virtualFile);
