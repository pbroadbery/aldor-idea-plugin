...
public class SpadAbbrevStubbingImpl {

    public static class SpadAbbrevMixin extends StubBasedPsiElementBase<SpadAbbrevStub> implements SpadAbbrev {
    ...
    public static class SpadAbbrevConcreteStub  extends StubBase<SpadAbbrev> implements SpadAbbrevStub {
